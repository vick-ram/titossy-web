<template>
  <div class="flex flex-col md:grid md:grid-cols-12 md:gap-4">
    ...
    <div class="col-span-8 md:col-span-8 mt-6 flex flex-col space-y-2 md:grid md:grid-cols-3 gap-2">
      ...
      <ElevatedCard class="relative p-6">
        ...
        >
          <span class="material-symbols-outlined text-white dark:text-slate-600"
            >print</span
          >
        </div>
        <div
        ...
        <p class="text-gray-600">
          <span
            class="bg-blue-100 text-blue-800 text-xs font-bold me-2 px-2.5 py-0.5 rounded-full dark:bg-blue-900 dark:text-blue-300"
            >2.5%</span
          >
          than last week
        </p>
    ...
    <div class="col-span-4 mt-6 flex justify-center items-center">
      <ElevatedCard class="py-9">
        <h4 class="text-gray-600 font-semibold dark:text-slate-100">
          Inventory Analytics
        </h4>
  ...
  <ElevatedCard class="mt-6">
    <h4 class="mb-5 text-gray-900 font-bold text-base">
    ...
    <div class="relative overflow-x-auto">
      ...
      >
        ...
        <tbody>
          <tr
            v-for="transaction in recentCustPayments"
  ...
  <ElevatedCard class="mt-6">
    <h4 class="mb-5 text-gray-600 font-bold text-base">
      Supplier Recent Transactions
    </h4>
    <div class="relative overflow-x-auto">
      <table
        class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400"
      >
        ...
        <tbody>
          <tr
            v-if="recentSupPayments.length !== 0"
            v-for="transaction in recentSupPayments"
            :key="transaction.paymentId"
            class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
          >
            <td scope="row" class="px-6 py-4">{{ transaction.paymentId }}</td>
...
const recentSupPayments = computed(
  () => transactionStore.recentSupplierTransactions
);
...
const series = computed(() =>
  productStore.products.map((product) => product.stock)
);
...
const colors = computed(() =>
  productStore.products.map(() => randomColor())
);
